                                            ...
                                            <table id="example-history"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($orders as $order)
                                                        <tr>
                                                            <?php
                                                            $data = Stockdata::where('isin', $order->isIn)->first();
                                                            // Check if data exists
                                                            $logo = $data ? $data->logo : null;
                                                            
                                                            ?>
                                                            <td>{{ $order->created_at }}</td> <!-- Created date -->
                                                            <td>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge badge-sm {{ $order->order_type == 'buy' ? 'badge-success' : 'badge-danger' }}">
                                            ...
                                            <table id="example-history-1"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>Limit</td>
                                                        <td>-</td>
                                                        <td><span class="badge badge-sm badge-light">$100.00</span>
                                                        </td>
                                                        <td>576.76</td>
                                                        <td>
                                                            <div class=" text-end">
