        ...
        <div class="col-xl-12">
            ...
            @if ($fetch->isEmpty())
                {{-- <div class="alert alert-danger text-center" role="alert">
                        No Such Data Found. Please first add to watchlist.
                    </div> --}}
                <div class="error-page" style="height: 50vh;">
                    <div class="error-inner text-center">
                        ...
                        <a onclick="showWatchlist('mcx',{{ $data2 }})" data-bs-toggle="offcanvas"
                            data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"
                            class="btn btn-secondary">ADD WATCHLIST</a>
                    </div>
                </div>
            @else
                <div class="row">
                    ...
                    <div class="offcanvas offcanvas-bottom" tabindex="-1"
                        id="orderoffcanvasBottom3{{ $i }}" aria-labelledby="offcanvasBottomLabel"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body pt-2">
                                            <div class="tab-content" id="nav-tabContent">
                                                    ...
                                                    <div class="table-responsive dataTabletrade">
                                                        <form id="buyform{{ $i }}"
                                                            ...
                                                            <input type="text" name="row" value="3"
                                                                id="row" hidden>
                                                            <input type="text"
                                                                name="instrumentKey31{{ $i }}"
                                                                value="{{ $foisin }}"
                                                                id="instrumentKey31{{ $i }}" hidden>
                                                            <input type="text"
                                                                name="instrumentType31{{ $i }}"
                                                            ...
                                                            <div class="col-xl-4" style="width: 100%;">
                                                                <div class="card">
                                                                    <div class="card-body pt-2">
                                                                        ...
                                                                        <div id="stoplossblock31{{ $i }}"
                                                                            class="input-group mb-3">
                                                                            <span class="input-group-text">Stop Loss
                                                                            </span>
                                                                            <input id="stoploss31{{ $i }}"
                                                                                name="stoploss31{{ $i }}"
                                                                        ...
                                                                        <div class=""
                                                                            ...
                                                                            <div class="d-flex flex-column gap-2 w-50">
                                                                                ...
                                                                                <div class=" input-group mb-3">
                                                                                    <button
                                                                                        onclick="decrementLot({{ $quantity }}, {{ $i }},{{ $user->real_wallet }}, 'buy',3)"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        id="intradayMode31{{ $i }}"
                                                                                        value="intraday"
                                                                                        onchange="handleTradeModeChange({{ $i }}, 'intraday','buy',3)"
                                                                                        checked>
                                                                                    <label class="form-check-label"
                                                                                        for="intradayMode31{{ $i }}">
                                                                                        Intraday
                                                                                    </label>
                                                                                </div>
                                                                                ...
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        id="deliveryMode31{{ $i }}"
                                                                                        value="delivery"
                                                                                        onchange="handleTradeModeChange({{ $i }}, 'delivery','buy',3)">
                                                                                    <label class="form-check-label"
                                                                                        for="deliveryMode31{{ $i }}">
                                                                                        Delivery
                                                                                    </label>
                                                                                </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            BUY @ ₹ <span id="stockrealprice31{{ $i }}" > {{ $stock->ask }}</span></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="tab-pane fade" id="nav-history3{{ $i }}"
                                                    role="tabpanel">
                                                    <div class="table-responsive dataTabletrade">
                                                        <form id="sellform" name="sellform{{ $i }}"
                                                            ...
                                                            <input type="text" name="id2"
                                                                value="{{ $i }}" id="id2" hidden>

                                                            <input type="text" name="row2" value="3"
                                                                id="row2" hidden>
                                                            <input type="text"
                                                                name="instrumentKey32{{ $i }}"
                                                                value="{{ $foisin }}"
                                                                id="instrumentKey32{{ $i }}" hidden>
                                                            <input type="text"
                                                                name="instrumentType32{{ $i }}"
                                                                value="{{ $instrumentType }}"
                                                            ...
                                                            <div class="col-xl-4" style="width: 100%;">
                                                                <div class="card">
                                                                    <div class="card-body pt-2">
                                                                        ...
                                                                        <div id="stoplossblock32{{ $i }}"
                                                                            class="input-group mb-3">
                                                                            <span class="input-group-text">Stop Loss
                                                                            </span>
                                                                            <input id="stoploss32{{ $i }}"
                                                                                name="stoploss32{{ $i }}"
                                                                                type="text" class="form-control"
                                                                                placeholder="Enter price">
                                                                        ...
                                                                        <div class=""
                                                                            ...
                                                                            <div class="d-flex gap-2 w-50 flex-column">
                                                                                ...
                                                                                <div class="input-group mb-3">
                                                                                    <button
                                                                                        onclick="decrementLot({{ $quantity }}, {{ $i }},{{ $user->real_wallet }},'sell',3)"
                                                                                        class="btn btn-outline-secondary"
                                                                                        type="button"
                                                                                        id="decrement">-</button>
                                                                                    <input type="text"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        id="intradayMode32{{ $i }}"
                                                                                        value="intraday"
                                                                                        onchange="handleTradeModeChange({{ $i }}, 'intraday','sell',3)"
                                                                                        checked>
                                                                                    <label class="form-check-label"
                                                                                        for="intradayMode32{{ $i }}">
                                                                                        Intraday
                                                                                    </label>
                                                                                </div>
                                                                                <!-- Delivery Mode Radio Button -->
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        id="deliveryMode32{{ $i }}"
                                                                                        value="delivery"
                                                                                        onchange="handleTradeModeChange({{ $i }}, 'delivery','sell',3)">
                                                                                    <label class="form-check-label"
                                                                                        for="deliveryMode32{{ $i }}">
                                                                                        Delivery
                                                                                    </label>
                                                                                </div>
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            SELL @ ₹<span id="stockrealprice32{{ $i }}" > {{ $stock->bid }}</span></button>
                                                                        </div>
                            ...
                            <div class="card-header border-0 pb-0 d-flex justify-content-between align-items-center">
                                ...
                                if ($change > 0) {
                                        ...
                                        <span class="text-danger"
                                            id="perc3{{ $i }}">{{ number_format(($change / $stock->cp) * 100, 2) }}%
                                            &nbsp;</span>
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        {{-- <p class="mb-0" style="position: absolute;top: 54px;right: 14px;"> --}}
                                          <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span id="ltp3{{ $i }}" class="fw-bold text-primary fs-4">
                                                {{ $stock->ltp }}</span>
                                            </div>
                                        {{-- </p> --}}
                                    </div>
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <div class="me-3">
                                        <p class="mb-0">Bid : <span class="text-dark mb-0 font-w600"
                                                id="bid3{{ $i }}">{{ $stock->bid }}</span></p>
                                    </div>
                                    <div class="me-3">
                                        <p class="mb-0">Ask : <span class="text-dark mb-0 font-w600"
                                                id="ask3{{ $i }}">{{ $stock->ask }}</span></p>
                                    </div>
                                </div>
