...
<div>
    ...
    <div class="row">
        <div class="col-xl-12">
            @php
            $fetch = DB::table('watchlist')->where('userId', $user->id)->where('instrumentType',
            'FUT')->where('segment','NSE_FO')->get();
            @endphp
            ...
            <div class="error-page" style="height: 50vh;">
                <div class="error-inner text-center">
                    ...
                    <a onclick="showWatchlist('future',{{ $data }})" data-bs-toggle="offcanvas"
                        data-bs-target="#offcanvasRight" aria-controls="offcanvasRight" class="btn btn-secondary">ADD
                        WATCHLIST</a>
                </div>
            </div>
            @else
                            ...
                            <div class="modal-body p-3">
                                <div class="d-flex flex-column gap-3">
                                    <div class="trade-item d-flex align-items-center p-2 rounded border shadow-sm"
                                        ...
                                        <img src="https://cdn-icons-png.flaticon.com/128/15342/15342293.png" width="30"
                                            class="me-2" alt="Trade Logo">
                                    ...
                                    <div class="trade-item d-flex align-items-center p-2 rounded border shadow-sm"
                                        ...
                                        <img src="https://cdn-icons-png.flaticon.com/128/2285/2285559.png" width="30"
                                            class="me-2" alt="Chart Logo">
                                    ...
                                    <div class="trade-item d-flex align-items-center p-2 rounded border shadow-sm"
                                        ...
                                        data-bs-dismiss="modal">
                                        <img src="https://cdn-icons-png.flaticon.com/128/4519/4519615.png" width="30"
                                            class="me-2" alt="Details Logo">
                                    ...
                                    <div class="trade-item d-flex align-items-center p-2 rounded border shadow-sm text-danger"
                                        ...
                                        <img src="https://cdn-icons-png.flaticon.com/128/1450/1450571.png" width="30"
                                            class="me-2" alt="Remove Logo">
                                    ...
                                    <div class="card-header flex-wrap">
                                        ...
                                        <nav class="" style="width: 100%;">
                                            <div class="nav nav-pills light " id="nav-tab" role="tablist">
                                                <button class="nav-link active " style="width: 50%;" id="nav-order-tab"
                                                    data-bs-toggle="tab" data-bs-target="#nav-order1{{ $i }}"
                                                    type="button" role="tab" aria-selected="true">Buy</button>
                                            ...
                                            <div class="tab-pane fade show active" id="nav-order1{{ $i }}"
                                                ...
                                                <div class="table-responsive dataTabletrade">
                                                    <form id="buyform1{{ $i }}" name="buyform1{{ $i }}" method="POST"
                                                        ...
                                                        <input type="text" name="row" value="1" id="row" hidden>
                                                        <input type="text" name="instrumentKey11{{ $i }}"
                                                            value="{{ $foisin }}" id="instrumentKey11{{ $i }}" hidden>
                                                        <input type="text" name="instrumentType11{{ $i }}"
                                                            value="{{ $instrumentType }}" id="instrumentType11{{ $i }}"
                                                            hidden>
                                                        <div class="col-xl-4" style="width: 100%;">
                                                            <div class="card">
                                                                <div class="card-body pt-2">
                                                                    ...
                                                                    <!-- Limit Input -->
                                                                    <div id="limitblock11{{ $i }}" style="display: none"
                                                                    ...
                                                                    <div id="targetpriceblock11{{ $i }}"
                                                                        ...
                                                                        <input id="targetprice11{{ $i }}"
                                                                            name="targetprice11{{ $i }}" type="text"
                                                                            class="form-control"
                                                                            placeholder="Enter price">
                                                                    ...
                                                                    {{-- marketstoploss input --}}
                                                                    {{-- <div id="targetpriceblock11{{ $i }}"
                                                                        style="display: none" class="input-group mb-3">
                                                                        <span class="input-group-text">Target Price
                                                                        </span>
                                                                        <input id="targetprice11{{ $i }}"
                                                                            ...
                                                                            <div class="d-flex flex-column">
                                                                                <span>
                                                                                    Cost: <s id="costPrice11{{ $i }}"
                                                                                        name="costPrice1{{ $i }}"
                                                                                        class="px-1">₹ {{
                                                                                        number_format($stock->ltp*1*$quantity,2)
                                                                                        }}(500x)</s><span
                                                                                ...
                                                                                <span>
                                                                                    After Margin: <span
                                                                                        id="marginCost11{{ $i }}"
                                                                                        class="text-success">₹{{
                                                                                        number_format($stock->ltp*1*$quantity/500,2)
                                                                                        }}</span>
                                                                                </span>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="mt-3 d-flex justify-content-between">
                                                                        {{-- <button type="subit"
                                                                            class="btn btn-success btn-sm  text-uppercase me-3 btn-block fw-bold">BUY
                                                                            <span class="me-3"
                                                                                id="stockrealprice11{{ $i }}"> {{
                                                                                $stock->ask }}</span></button> --}}
                                                                        {{-- <button type="subit"
                                                                            class="btn btn-success btn-sm text-uppercase me-3 w-100 d-flex justify-content-center gap-2 align-items-center fw-bold px-3 py-2">
                                                                            <span>BUY</span>
                                                                            <span id="stockrealprice11{{ $i }}">  {{
                                                                                $stock->ask }}</span>
                                                                        </button> --}}
                                                                        <button type="subit"
                                                                                class="btn btn-success text-uppercase fw-bold text-center w-100 py-3 fs-5">
                                                                            BUY @ ₹ <span id="stockrealprice11{{ $i }}">{{ $stock->ask }}</span>
                                                                        </button>
                                            ...
                                            <div class="tab-pane fade" id="nav-history1{{ $i }}" role="tabpanel">
                                                <div class="table-responsive dataTabletrade">
                                                    <form id="sellform1{{ $i }}" name="sellform1{{ $i }}" method="POST"
                                                        ...
                                                        @csrf
                                                        <input type="text" name="id2" value="{{ $i }}" id="id2" hidden>
                                                        <input type="text" name="row2" value="1" id="row2" hidden>
                                                        <input type="text" name="instrumentKey12{{ $i }}"
                                                            value="{{ $foisin }}" id="instrumentKey12{{ $i }}" hidden>
                                                        <input type="text" name="instrumentType12{{ $i }}"
                                                            value="{{ $instrumentType }}" id="instrumentType12{{ $i }}"
                                                            hidden>
                                                        <div class="col-xl-4" style="width: 100%;">
                                                            <div class="card">
                                                                <div class="card-body pt-2">
                                                                    ...
                                                                    <!-- Limit Input -->
                                                                    <div id="limitblock12{{ $i }}" style="display: none"
                                                                        class="input-group mb-3">
                                                                        <span class="input-group-text">Limit
                                                                            Price</span>
                                                                    ...
                                                                    <div id="targetpriceblock12{{ $i }}"
                                                                        ...
                                                                        <input id="targetprice12{{ $i }}"
                                                                            name="targetprice12{{ $i }}" type="text"
                                                                            class="form-control"
                                                                            placeholder="Enter price">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div class="d-flex">
                                                                            <div>Max:</div>
                                                                            <div id="maxPrice12{{ $i }}" class=" px-1">
                                                                                ₹{{ $user->real_wallet }}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mt-3 d-flex justify-content-between">
                                                                        ...
                                                                        <button type="submit"
                                                                            ...
                                                                            SELL @ ₹ <span id="stockrealprice12{{ $i }}"> {{
                                                                                $stock->bid }}</span></button>
                                                                    </div>
                              ...
                              <div class="d-flex justify-content-between ">
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        {{-- <span class="text-muted fs-6">LTP</span> --}}
                                         <span id="ltp1{{ $i }}" class="fw-bold text-primary fs-4">
                                            {{ $stock->ltp }}</span>
                                    </div>
