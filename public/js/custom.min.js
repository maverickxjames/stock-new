    ...
    var t = function () {
        ...
        a = function () {
            if (jQuery(".portofolio-social").length > 0) {
                let e = document.querySelectorAll(".portofolio-social li");
                e.forEach((e) => {
                    let t = 0,
                        n = 0,
                        a = 1,
                    ...
                    e.addEventListener("mousemove", (t) => {
                        ...
                        !(function c() {
                            (t = Math.floor(100 * (t = r(t, l, 0.1))) / 100),
                                (n =
                                    Math.floor(100 * (n = r(n, o, 0.1))) / 100),
                                (a =
                                    Math.floor(100 * (a = r(a, i, 0.05))) /
                                    100),
                ...
                jQuery(document).on("scroll", function () {
                    ...
                    jQuery(".navbar-nav .scroll").each(function () {
                        var n,
                            a = jQuery(this);
                        jQuery(a.attr("href")),
                            parseInt(jQuery(this.hash).offset().top, 10) - t <=
                                e &&
                                (jQuery(".navbar-nav .scroll")
                                    .parent()
                                    .removeClass("active"),
